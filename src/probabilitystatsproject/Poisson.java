 ...
 * Creates a Poisson object with parameter lambda
 * Get the mathematics branch, type of distribution, mean, standard deviation, variance, use cases, and more use cases
 * Provide a description of the Poisson object
 * Throw exceptions if invalid parameters were used
 *
 */

// A Poisson is-a Discrete and is SummaryProbability, UseCases, and AddUseCases
public class Poisson extends Discrete implements SummaryProbability, UseCases, AddUseCases
{
	private double lambda; // A Poisson has-a (parameter) lambda
	private double parameter[] = new double[1]; // A Poisson has-a parameter
	private String[] useCases; // A Poisson has-a useCases
	private String[] newUseCases; // A Poisson has-a newUseCases
	...
	/** Purpose: Creates a Poisson object given parameter lambda
	 * @param lambda
	 * @return none
	 */
	...
	/** Purpose: Describes Poisson distribution given parameters or gives shortened description
	 * @param none
	 * @return Description of Poisson distribution or shortened description
	 */
	...
	public String toString()
	{
		try
		{
			...
			{
				return "The Poisson distribution has parameter lambda = " + parameter[0] +  
		...
		catch (InvalidParameterException ex)
		{
			...
			if (moreUseCasesToString() == null)
			{
				return "Displaying default error values: \n" + 
						...
						"The Poisson distribution is a " + super.getType() + " distribution studied under " + super.getBranch()
						+ ".\nSome use cases are " + useCasesToString() + ".\n";
			}
